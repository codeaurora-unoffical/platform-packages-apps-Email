...
public final class Account extends EmailContent implements AccountColumns, Parcelable {
    ...
    public int mSyncSize;    // add for feature: Sync size per mail
    ...
    public static final int CONTENT_SYNC_SIZE_COLUMN = 20;    // add for feature: Sync size per mail
    ...
    /**
     * Set the max size each mail will be synced from service.  Be sure to call save() to commit to database.
     * TODO define the values for "all", "20KB", "100KB", etc.  See arrays.xml
